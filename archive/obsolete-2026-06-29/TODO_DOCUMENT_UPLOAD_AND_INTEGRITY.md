...
3. Add upload/vault regression tests
...
2. Confirm front-end upload integration
...
1. Review `VaultEngine` resource scopes
...
## Optional improvement
 ...
 1. Consider global document ID generation
