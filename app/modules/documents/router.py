...
Migrated from app/routers/documents.py into the documents SDK module.
All imports remain absolute since documents is a CORE module that depends
on shared infrastructure (database, security, event bus, vault services).
