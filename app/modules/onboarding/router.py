...
def create_router(config: OnboardingConfig) -> APIRouter:
    ...
    async def role_select_static(request: Request, fresh: str | None = Query(None)):
        """Redirect legacy /onboarding/role-select to the canonical page.

        The static file this used to serve had no disclaimer footer — a
        compliance gap. The canonical page is generated by
        ``_render_role_selection_page`` (which includes the unified footer).
