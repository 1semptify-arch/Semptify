...
Migrated from app/routers/eviction_defense.py into the eviction_defense SDK module.
All imports remain absolute since eviction_defense is an EXTENDED module that
depends on shared infrastructure (security, law_engine, form_data, document_hub).
