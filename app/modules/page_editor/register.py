...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL list of editable files in the project. Returns file "
        "paths, types, and sizes. Admin-only."
    ),
    inputs=("user_id",),
    outputs=("files",),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL get a file's content by path. Returns the file content "
        "as text. Admin-only."
    ),
    inputs=("path", "user_id"),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL save a file's content. Writes the new content to the "
        "file at the given path. Admin-only."
    ),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL search across editable files. Returns matching files "
        "and line numbers. Admin-only."
    ),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL redirect to the page editor UI. Admin-only."
    ),
    inputs=(),
    outputs=("redirect",),
    dependencies=("app.modules.page_editor.router",),
