...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL OpenAPI 3.0 specification. Returns the full API spec "
        "as JSON. Admin-only."
    ),
    inputs=(),
    outputs=("spec",),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL Postman collection. Returns the API as a Postman "
        "collection for import into Postman. Admin-only."
    ),
    inputs=(),
    outputs=("collection",),
    dependencies=("app.modules.documentation.router",),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL Swagger UI. Returns an HTML page with interactive "
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL ReDoc UI. Returns an HTML page with ReDoc interactive "
        "API documentation. Admin-only."
    ),
    inputs=(),
    outputs=("html",),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL developer portal. Returns an HTML page with links to "
        "all documentation resources. Admin-only."
    ),
    inputs=(),
    outputs=("html",),
    dependencies=("app.modules.documentation.router",),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL code examples. Returns example code for using the API, "
        "filterable by language and category."
    ),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL single code example by ID. Returns the full example "
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL support resources. Returns links to docs, community, "
        "and contact info for support."
    ),
    inputs=(),
    outputs=("resources",),
    dependencies=("app.modules.documentation.router",),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL API changelog and version history. Returns all "
        "changes organized by version."
    ),
    inputs=(),
    outputs=("changelog",),
    dependencies=("app.modules.documentation.router",),
