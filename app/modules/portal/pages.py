...
class PortalPageRegistry:
    ...
    PAGES: ClassVar[list[PortalPage]] = [
        ...
        PortalPage(
            id="plugins",
            title="Plugins — Semptify",
            path="/plugins",
            template="public/plugins.html",
            description="Semptify plugins and the plugin directory. Browser extension, desktop app, and local script support is coming soon.",
            keywords="semptify plugins, semptify pi, browser extension, desktop app, local script, tenant tools",
            og_title="Plugins — Semptify",
            og_description="Semptify plugins and the plugin directory are coming soon.",
            footer_label="Plugins",
            in_footer=False,
            order=75,
        ),
        PortalPage(
