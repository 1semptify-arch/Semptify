...
Migrated from app/routers/storage.py into the storage SDK module.
All imports remain absolute since storage is a CORE module that depends
...
# Reconnect is a gate enforcement concern (storage_connected gate), not a storage
# infrastructure concern. The onboarding module owns the full gate lifecycle.
...
# _generate_reconnect_html moved to app/modules/onboarding/reconnect.py as _reconnect_html
...
async def initiate_oauth(
    ...
    try:
        ...
        # Safe to call — DELETE permission confirmed working (callback calls this too).
