...
register_function_group(
    FunctionGroupContract(
        ...
        description=(
            "CANONICAL initiate OAuth flow for a storage provider. Redirects to the provider's authorization page."
        ),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=(
            "CANONICAL JSON list of storage providers. Returns provider codes and metadata as JSON for API consumers."
        ),
        inputs=("semptify_uid?"),
        outputs=("providers",),
        dependencies=("app.modules.storage.router",),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=(
            "CANONICAL logout. Clears the auth cookie, revokes the session, and redirects to the welcome page."
        ),
        inputs=("semptify_uid?"),
        outputs=("success",),
        dependencies=("app.modules.storage.router",),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=(
            "CANONICAL verify a SEMPTIFY certificate by ID. Returns whether the certificate is valid and its metadata."
        ),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=(
            "CANONICAL verify a function-scoped token. Returns whether the token is valid and its associated user_id."
        ),
