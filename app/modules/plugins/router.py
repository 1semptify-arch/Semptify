...
"""
# Migrated from app/routers/plugins.py into the plugins SDK module.
# All imports remain absolute since plugins is a CORE module.
...
from app.sdk.plugin_manager import PluginStatus, plugin_manager
...
async def list_plugins(
    ...
    try:
        ...
        for _plugin_name, plugin_info in plugin_manager.plugins.items():
            # Apply filters
