...
async def etiquette_rules():
    ...
    return [
        {"rule": "Dress as if appearing in person", "detail": "Court-appropriate attire shows respect for the process"},
        {
            "rule": "Mute microphone when not speaking",
            "detail": "Prevents background noise from disrupting the hearing",
        },
        {"rule": "Speak clearly and slowly", "detail": "Audio quality can be poor — enunciate and pace yourself"},
        {"rule": "Wait for your turn to speak", "detail": "The judge will indicate when you should respond"},
        {"rule": "Have your case number ready", "detail": "State your name and case number when asked"},
        {"rule": "Keep your camera on unless told otherwise", "detail": "Visual presence is expected in most hearings"},
        {
            "rule": "No eating or drinking during hearing",
            "detail": "Wait until the hearing is officially paused or concluded",
        },
        {"rule": "Be in a private space", "detail": "No children, pets, or other people in the background"},
        {"rule": "Address the judge as 'Your Honor'", "detail": "Standard courtroom courtesy applies virtually"},
        {"rule": "Take notes", "detail": "Write down deadlines, next hearing dates, and instructions"},
    ]
