...
"""
# Migrated from app/routers/search.py into the search SDK module.
# All imports remain absolute since search is a CORE module.
        ...
        for result in results:
            ...
            response.documents.append(
                SearchResult(
                    ...
                    url=f"/documents?id={doc.document_id}",
                    score=result.score,
                    metadata={
