...
# Initialize router
pattern_history_router = APIRouter(
    prefix="/api/housing-accountability/patterns",
...
async def get_pattern_record_detail(
    ...
    try:
        result = await db.execute(
            ...
            .where(and_(
                PatternRecord.id == record_id,
                PatternRecord.user_id == current_user.id
            ))
        )
