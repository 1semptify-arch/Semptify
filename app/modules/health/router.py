...
This router was migrated from app/routers/health.py into the health SDK module.
All imports remain absolute (pointing to app.core.*) since health is a CORE
module that depends on shared infrastructure.
