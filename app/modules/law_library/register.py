...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL detailed view of a single court rule. Returns full text, "
        "citation, and related procedures."
    ),
    inputs=("rule_id",),
    outputs=("court_rule",),
    dependencies=("app.modules.law_library.router",),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL detailed view of a single case. Returns full case text, "
        "citation, holding, and related statutes."
    ),
    inputs=("case_id",),
    outputs=("case",),
    dependencies=("app.modules.law_library.router",),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL list of all categories in the law library. Used by the "
        "tenant UI to render category navigation."
    ),
    inputs=(),
    outputs=("categories",),
    dependencies=("app.modules.law_library.router",),
