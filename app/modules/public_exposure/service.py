...
class PublicExposureService:
    ...
    def get_press_release(self, release_id: str) -> PressRelease | None:
        """Get a press release by ID"""
        return self._releases.get(release_id)

    def get_media_kit(self, kit_id: str) -> MediaKit | None:
        """Get a media kit by ID"""
        return self._kits.get(kit_id)

    def get_mn_media_outlets(self, outlet_type: MediaOutlet | None = None) -> list[dict[str, str]]:
...
# Global instance
_public_service: PublicExposureService | None = None
