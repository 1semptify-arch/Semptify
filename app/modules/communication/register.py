...
register_function_group(
    FunctionGroupContract(
        ...
        description=("CANONICAL send a message in a conversation. Returns the new message with ID and timestamp."),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=("CANONICAL mark a single message as read. Updates the read receipt for the message."),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=("CANONICAL mark all messages in a conversation as read. Updates the unread count to zero."),
