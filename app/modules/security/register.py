...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL enable 2FA after successful verification. Activates "
        "2FA requirement for the user's account."
    ),
    inputs=("user_id", "code"),
    outputs=("enabled",),
    dependencies=("app.modules.security.router",),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL validate a session. Returns whether the session is "
