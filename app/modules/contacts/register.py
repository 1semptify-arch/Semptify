...
register_function_group(
    FunctionGroupContract(
        ...
        description=("CANONICAL get a single contact by ID. Returns full contact info including interactions log."),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=("CANONICAL update a contact. The tenant can edit name, phone, email, address, or notes."),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=("CANONICAL delete a contact. Removes the contact and all associated interactions."),
        inputs=("contact_id", "user_id"),
        outputs=("status",),
        dependencies=("app.modules.contacts.router",),
        deterministic=False,
...
register_function_group(
    FunctionGroupContract(
        ...
        description=("CANONICAL star or unstar a contact. Starred contacts appear at the top of the contacts list."),
        inputs=("contact_id", "user_id"),
        outputs=("starred",),
        dependencies=("app.modules.contacts.router",),
        deterministic=False,
