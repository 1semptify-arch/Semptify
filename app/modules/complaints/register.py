...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL list of complaint drafts for a user. Returns all drafts "
        "with status (draft, filed, archived)."
    ),
    inputs=("user_id",),
    outputs=("drafts",),
    dependencies=("app.modules.complaints.router",),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL retrieval of a specific complaint draft. Returns the full "
        "draft text and metadata."
    ),
    inputs=("draft_id",),
    outputs=("draft",),
    dependencies=("app.modules.complaints.router",),
...
register_function_group(FunctionGroupContract(
    ...
    description=(
        "CANONICAL deletion of a complaint draft. Removes the draft and "
        "all associated data."
    ),
    inputs=("draft_id",),
    outputs=("status",),
