...
register_function_group(
    FunctionGroupContract(
        ...
        description=("CANONICAL get a single calendar event by ID. Returns full event details."),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=("CANONICAL update a calendar event. The tenant can edit title, date, description, or event type."),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=("CANONICAL delete a calendar event. Removes the event from the calendar."),
        inputs=("event_id", "user_id"),
        outputs=("status",),
        dependencies=("app.modules.calendar.router",),
        deterministic=False,
