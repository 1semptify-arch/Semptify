...
"""
# Migrated from app/routers/preview.py into the preview SDK module.
# All imports remain absolute since preview is a CORE module.
...
async def serve_preview(cache_key: str):
    ...
    try:
        ...
        preview_result = None
        for _key, result in generator.preview_cache.items():
