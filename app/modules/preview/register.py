...
register_function_group(
    FunctionGroupContract(
        ...
        description=(
            "CANONICAL serve a generated preview by cache_key. Returns the preview content (image, HTML, or text)."
        ),
        inputs=("cache_key",),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=(
            "CANONICAL get a text preview of a document. Returns the extracted text content for the document."
        ),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=(
            "CANONICAL clear the preview cache for a specific document. Forces regeneration on next preview request."
        ),
        inputs=("document_id", "user_id"),
        outputs=("cleared",),
        dependencies=("app.modules.preview.router",),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=(
            "CANONICAL preview cache statistics. Returns cache size, hit rate, and document count. Admin-only."
        ),
        inputs=("user_id",),
        outputs=("stats",),
        dependencies=("app.modules.preview.router",),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=(
            "CANONICAL list of supported document formats for preview. Returns format codes and descriptions."
        ),
        inputs=(),
        outputs=("formats",),
        dependencies=("app.modules.preview.router",),
...
register_function_group(
    FunctionGroupContract(
        ...
        description=(
            "CANONICAL clear all preview cache. Admin-only. Removes all cached previews, forcing regeneration."
        ),
        inputs=("user_id",),
        outputs=("cleared",),
        dependencies=("app.modules.preview.router",),
