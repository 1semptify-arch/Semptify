...
Migrated from app/routers/timeline_unified.py into the timeline SDK module.
All imports remain absolute since timeline is a CORE module that depends
on shared infrastructure (database, security, models, overlay manager).
