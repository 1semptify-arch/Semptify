...
class AIToolCrib:
    ...
    def get_service(self, service_type: AIServiceType) -> Optional[AIServiceConfig]:
    ...
    def get_metrics(self, service_type: Optional[AIServiceType] = None) -> Dict[str, AIServiceMetrics]:
    ...
    def get_cost_report(self, start_date: Optional[datetime] = None) -> Dict[str, float]:
