...
class InventoryManager:
    ...
    def get_item_by_id(self, item_id: str) -> InventoryItem | None:
        """Get inventory item by ID."""
        return self.items.get(item_id)

    def rotate_inventory(self, inventory_type: InventoryType | None = None):
    ...
    def create_backup(self, source_path: str, tags: list[str] | None = None) -> str:
