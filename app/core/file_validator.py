...
class FileValidator:
    ...
    ALLOWED_TYPES = {
        ...
        "txt": {"mime_types": ["text/plain"], "max_size_mb": 10, "description": "Plain text file", "risk_level": "low"},
        "rtf": {
        ...
        # Images
        "jpg": {"mime_types": ["image/jpeg"], "max_size_mb": 20, "description": "JPEG image", "risk_level": "low"},
        "jpeg": {"mime_types": ["image/jpeg"], "max_size_mb": 20, "description": "JPEG image", "risk_level": "low"},
        "png": {"mime_types": ["image/png"], "max_size_mb": 20, "description": "PNG image", "risk_level": "low"},
        "gif": {"mime_types": ["image/gif"], "max_size_mb": 10, "description": "GIF image", "risk_level": "low"},
        "tiff": {
    ...
    def validate_file(self, file_content: bytes, filename: str, file_size: int) -> FileValidationResult:
        ...
        if not file_content or file_size == 0:
            return FileValidationResult(is_valid=False, error_message="File is empty")
