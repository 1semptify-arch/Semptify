...
class GDPRComplianceManager:
    ...
    def _process_deletion_request(self, request: DataSubjectRequest) -> bool:
        ...
        try:
            ...
            if success:
                ...
                logger.info(f"Successfully processed GDPR deletion request {request.request_id}")
    ...
    def _get_document_content(self, document_id: str) -> bytes | None:
    ...
    def get_data_request(self, request_id: str) -> DataSubjectRequest | None:
