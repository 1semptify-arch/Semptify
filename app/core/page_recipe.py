...
class PageComponent:
    ...
    file_path: str | None = None  # Where it lives
...
class PageStep:
    ...
    next_step: int | None = None  # Next in sequence
...
class PageRecipe:
    ...
    # Completion
    completion_redirect: str | None = None  # Where to go when done
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "data_flow": {"inputs": self.data_inputs, "outputs": self.data_outputs},
            "error_handling": {"error_states": self.error_states, "recovery_paths": self.recovery_paths},
        }
...
class RecipeRegistry:
    ...
    @classmethod
    def get(cls, page_id: str) -> PageRecipe | None:
