...
class RelationshipMapper:
    ...
    def _assign_party_roles(self, parties: list[ExtractedEntity], text: str, reasoning: ReasoningChain):
        ...
        if parties and not parties[0].attributes.get("role") and ("v." in text or "vs." in text):
    ...
    def _build_party_relationships(
        ...
        reasoning.add_step(
            ...
            {},
            {"types": list({r.relationship_type for r in relationships})},
        )
    ...
    def _build_amount_relationships(
        ...
        for amount in amounts:
            ...
            if amount_type == "late_fee" and amount_value > 100:  # Rough heuristic for excessive fee
                may_be_illegal = True
        ...
        reasoning.add_step(
            ...
            {},
            {
                ...
                "types": list({r.amount_type for r in relationships}),
            },
        )
