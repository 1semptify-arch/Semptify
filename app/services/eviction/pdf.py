...
def generate_answer_pdf(
    ...
    if defense_details:
        defense_html += (
            f'<div class="section"><div class="section-title">Additional Details:</div>{defense_details}</div>'
        )
...
<body>
    ...
    <div class="signature-block">
        ...
        <div class="date-line">Date: {utc_now().strftime("%B %d, %Y")}</div>
    </div>
...
<body>
    ...
    <div class="footer">
        Generated by Semptify Eviction Defense System - {utc_now().strftime("%B %d, %Y")}
    </div>
</body>
</html>
"""
