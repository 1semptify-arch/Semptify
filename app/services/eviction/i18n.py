...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "home": {"en": "Home", "es": "Inicio", "so": "Guriga", "ar": "الرئيسية"},
    "back": {"en": "Back", "es": "Atrás", "so": "Dib", "ar": "رجوع"},
    "next": {"en": "Next", "es": "Siguiente", "so": "Xiga", "ar": "التالي"},
    "submit": {"en": "Submit", "es": "Enviar", "so": "Dir", "ar": "إرسال"},
    "download": {"en": "Download", "es": "Descargar", "so": "Soo Degso", "ar": "تحميل"},
    "save": {"en": "Save", "es": "Guardar", "so": "Kaydi", "ar": "حفظ"},
    "cancel": {"en": "Cancel", "es": "Cancelar", "so": "Jooji", "ar": "إلغاء"},
    # Main Menu
    "answer_summons": {
    ...
    # Answer Flow
    "step": {"en": "Step", "es": "Paso", "so": "Tallaabo", "ar": "خطوة"},
    "of": {"en": "of", "es": "de", "so": "ka mid ah", "ar": "من"},
    "your_information": {"en": "Your Information", "es": "Su Información", "so": "Macluumaadkaaga", "ar": "معلوماتك"},
    "tenant_name": {"en": "Your Full Name", "es": "Su Nombre Completo", "so": "Magacaaga Buuxa", "ar": "اسمك الكامل"},
    "landlord_name": {
        "en": "Landlord's Name",
    ...
    "hearing_time": {"en": "Hearing Time", "es": "Hora de Audiencia", "so": "Waqtiga Dhageysiga", "ar": "وقت الجلسة"},
    "is_zoom_hearing": {
