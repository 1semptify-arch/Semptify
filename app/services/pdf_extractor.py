...
class PDFExtractor:
    ...
    def _extract_pymupdf(self, content: bytes) -> ExtractionResult | None:
    ...
    def _extract_pypdf2(self, content: bytes) -> ExtractionResult | None:
    ...
    def _local_ocr(self, content: bytes) -> ExtractionResult | None:
        """
