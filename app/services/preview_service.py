...
class PreviewResult:
    ...
    text_content: str | None = None  # For text-based previews
...
class PreviewService:
    ...
    # Cache directory
    CACHE_DIR = Path("/tmp/semptify_previews")  # noqa: S108  # intentional shared cache location

    def __init__(self):
        self.CACHE_DIR.mkdir(parents=True, exist_ok=True)

    def _get_file_category(self, filename: str, mime_type: str | None = None) -> FileCategory:
