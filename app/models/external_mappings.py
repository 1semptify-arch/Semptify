...
class ExternalMapping(Base):
    ...
    external_url: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)  # Link to external system
    
    # Semptify reference (what internal item this maps to)
    semptify_entity_type: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)  # document, event, complaint
    semptify_entity_id: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    
    # Mapping metadata
    display_name: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)  # Human-readable name
...
class CourtCaseMapping(Base):
    ...
    division: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)  # Housing, Civil, etc.
    ...
    attorney_bar_numbers: Mapped[Optional[str]] = mapped_column(Text, nullable=True)  # JSON array
    ...
    # External links
    case_portal_url: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    document_filing_url: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    
    # Semptify connections
    semptify_complaint_id: Mapped[Optional[str]] = mapped_column(String(36), nullable=True)
    semptify_timeline_event_ids: Mapped[Optional[str]] = mapped_column(Text, nullable=True)  # JSON array
...
class PropertyMapping(Base):
    ...
    municipality: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)  # minneapolis, st paul
    ...
    # Property details
    property_type: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)  # apartment, house, condo
    tax_id: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)  # Tax parcel ID
    
    # External system links
    county_assessor_url: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    county_recorder_url: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    gis_map_url: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    
    # Semptify connections
    semptify_lease_doc_id: Mapped[Optional[str]] = mapped_column(String(36), nullable=True)
...
class AgencyMapping(Base):
    ...
    submission_method: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)  # online, mail, in_person
    ...
    resolution_outcome: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    
    # External links
    agency_portal_url: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    ...
    semptify_document_ids: Mapped[Optional[str]] = mapped_column(Text, nullable=True)  # JSON array
...
def create_mapping(
    ...
    external_system: str,
    external_id: str,
    semptify_entity_type: Optional[str] = None,
    semptify_entity_id: Optional[str] = None,
    ...
    mapping = ExternalMapping(
        ...
        semptify_entity_type=septify_entity_type,
        semptify_entity_id=septify_entity_id,
