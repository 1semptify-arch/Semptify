...
For each URL: use `read_url_content` or `search_web` to confirm the site is live and the info matches.

For phone numbers: search_web for the org name + "phone number" to confirm current number.
