...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "package_type", sa.String(50), nullable=False
        ),  # certified_mail, priority, express, evidence, legal_document
        sa.Column(
            "package_subtype", sa.String(50), nullable=True
        ),  # return_receipt, signature_required, restricted_delivery
        # Addresses
        ...
        ),  # pending, in_transit, out_for_delivery, delivered, returned, failed
        sa.Column(
        ...
        sa.Column(
            "related_complaint_id", sa.String(36), sa.ForeignKey("complaints.id", ondelete="SET NULL"), nullable=True
        ),
        # Description/purpose
    ...
    op.create_table(
        ...
        # Attestation type
        sa.Column(
            "attestation_type", sa.String(50), nullable=False
        ),  # certified_receipt, delivery_confirmation, signature_proof, return_receipt
        ...
        # Source
        sa.Column(
            "source", sa.String(50), nullable=False, server_default="carrier_api"
        ),  # carrier_api, scanned_document, manual_entry, court_clerk
    ...
    op.create_table(
        ...
        sa.Column(
            "event_category", sa.String(30), nullable=False
        ),  # received, in_transit, out_for_delivery, delivered, exception, pickup_available
        # Location
    ...
    op.create_table(
        ...
        # Attachment details
        sa.Column(
            "attachment_type", sa.String(50), nullable=False
        ),  # photo, receipt_scan, label_scan, contents_photo, signature_capture
    ...
    # ==========================================================================
    op.create_index(
        "idx_packages_carrier_metadata_gin", "packages", [sa.text("carrier_metadata")], postgresql_using="gin"
    )

    op.create_index(
        "idx_attestations_metadata_gin", "package_attestations", [sa.text("metadata")], postgresql_using="gin"
    )

    op.create_index(
        "idx_package_events_raw_data_gin", "package_events", [sa.text("raw_event_data")], postgresql_using="gin"
    )
