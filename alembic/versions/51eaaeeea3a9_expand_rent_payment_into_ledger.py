...
revision: str = '51eaaeeea3a9'
down_revision: Union[str, Sequence[str], None] = 'aaebf71fa17a'
...
def upgrade() -> None:
    ...
    op.add_column('rent_payments', sa.Column('entry_type', sa.String(length=20), nullable=False, server_default=sa.text("'payment'")))
    op.add_column('rent_payments', sa.Column('period_covered', sa.String(length=20), nullable=True))
    op.add_column('rent_payments', sa.Column('source', sa.String(length=20), nullable=False, server_default=sa.text("'user_entered'")))
