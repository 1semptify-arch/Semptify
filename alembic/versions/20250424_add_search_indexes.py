...
down_revision: str | None = "20250424_add_invite_codes"
...
def upgrade() -> None:
    ...
    op.add_column("vault_items", sa.Column("search_vector", postgresql.TSVECTOR(), nullable=True))

    # Create GIN indexes for fast full-text search
    op.create_index("idx_documents_search_vector", "documents", ["search_vector"], postgresql_using="gin")

    op.create_index("idx_vault_items_search_vector", "vault_items", ["search_vector"], postgresql_using="gin")
