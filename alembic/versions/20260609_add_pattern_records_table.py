...
def upgrade():
    ...
    op.create_index(
        'ix_pattern_records_pattern_type',
        'pattern_records',
        ['pattern_type'],
        unique=False
    )
    ...
    op.create_index(
        'ix_pattern_records_extracted_at',
        'pattern_records',
        ['extracted_at'],
        unique=False
    )
    ...
    op.create_index(
        'ix_pattern_records_user_pattern',
        'pattern_records',
