...
| Management Address | 7645 Lyndale Ave S, Suite 210, Minneapolis, MN 55423 |
| Management Phone | (612) 243-3111 |
...
- [ ] **Landlord Harassment** - Management engaging in retaliatory conduct
- [ ] **Rental License Violations** - If property requires city license
- [ ] **Unfair Lease Practices** - Requesting backdated leases
- [ ] **Failure to Maintain Records** - No documentation for alleged violations
- [ ] **False Eviction Filings** - Based on fabricated claims
...
2. **Premeditated Eviction:** Our unit was listed for rent on August 17, 2025—BEFORE any alleged lease violation (August 18, 2025). This suggests evictions may be targeting tenants illegally.

3. **Fabricated Violations:** The management issued a "Serious Lease Infraction" notice with ZERO documentation—no incident reports, no witness statements, nothing.

4. **Defamatory Conduct:** Management made false written statements accusing a tenant of being "under the influence"—a serious, documented lie.

5. **Irregular Lease Practices:** Management requested we backdate our lease renewal—a practice that may violate rental licensing requirements.
...
| Aug 30, 2025 | Lease renewal signed; staff requested backdating |
| Sep 3, 2025 | Tenant sent Cease & Desist to Velair |
| Sep 4, 2025 | Velair directed tenant to attorney; threatened eviction |
| Sep 4, 2025 | Tenant filed MN Attorney General complaint |
| Sep 19, 2025 | Regional Manager made defamatory statements |
| Pending | Eviction action filed (Case #19AV-CV-25-3477) |

---

## WHAT WE'RE ASKING THE CITY TO DO

1. **Review Lexington Flats' rental license** (if applicable) for compliance with city requirements

2. **Investigate management practices** at the property for patterns of:
   - Tenant harassment
   - Fabricated violations
   - Retaliatory evictions

3. **Inspect documentation practices** to ensure property managers maintain proper records of lease violations as required

4. **Consider conditions on rental license** if violations are found, including:
   - Required training for management staff
   - Regular reporting to the city
   - Enhanced documentation requirements

5. **Refer to appropriate agencies** if criminal conduct (fraud, defamation) is suspected
...
| MN Dept of Commerce | Pending | Draft ready |
| Dakota County Court | Pending | Case #19AV-CV-25-3477 |
...
- Lease renewal and any backdating request
- Attorney General complaint confirmation
...
Call (651) 675-5675 first to ask what protections exist for Eagan renters and what the city can investigate.
