...
- Monthly Rent: $1,238.00 - $1,425.00
- Phone: (651) 867-4700
...
4. **LEASE FRAUD** - Irregular practices including backdating
5. **DEFAMATION** - False public accusations ("under the influence")
6. **MISUSE OF LAW ENFORCEMENT** - Calling police during peaceful inquiry
7. **PROCEDURAL MISCONDUCT** - Failure to follow proper notice/renewal procedures
...
| Request for Written Rationale | Sep 19, 2025 | Letter | Tenant demands evidence |
| Final Notice Before Legal Action | Sep 20/30, 2025 | Legal Notice | Cites MN statutes, demands compliance |
| Velair Response (Rossi) | Sep 19, 2025 | Email | "Belligerent manner" "under the influence" claims |
| Attorney General Report | Sep 4, 2025 | Government Filing | Formal complaint filed |
| HOME Line Consultation | Sep 23, 2025 | Legal Advice | Attorney Pattye Hechter guidance |
| RENTCafe Listing | Aug 17, 2025 | Website Print | Unit listed BEFORE alleged violation |
...
- Ledgers 1 & 2 (PDF - tables not extracted)
...
4. **Aug 30, 2025** - Tenants sign & return lease (asked to backdate)
5. **Sep 3, 2025** - Tenant sends Cease & Desist citing harassment
6. **Sep 4, 2025** - Velair threatens eviction, directs to attorney
7. **Sep 4, 2025** - Tenant files complaint with Minnesota Attorney General
8. **Sep 19, 2025** - Velair refuses to provide documentation, claims "under the influence"
...
- Issued to Dena Sazama only (not Bradley)
...
- 5 years of tenancy with zero infractions
...
1. **Injunctive Relief** - Cease all retaliatory actions
2. **Restoration of Lease Rights** - Void non-renewal decision
3. **Financial Damages** - Compensatory and statutory
4. **Declaratory Judgment** - Violation of anti-retaliation statutes
5. **Attorney's Fees & Costs**
6. **Harassment Restraining Order** (if applicable)
...
| Dakota County District Court | Pending | Legal action threatened |
...
- Private attorney list provided (March 2023)

---

## ⚠️ CRITICAL NEXT STEPS

1. [ ] Obtain police report (if any) from Lisa Burg's call
2. [ ] Request all incident reports through formal discovery
3. [ ] Document all future communications
4. [ ] Preserve all evidence (emails, texts, recordings)
5. [ ] File formal complaint with MN Dept. of Human Rights
6. [ ] Consult private attorney for representation
7. [ ] Prepare Tenant Remedies Action filing

---

*Case Summary Generated: December 11, 2025*
*Based on analysis of 75 documents from user uploads*
*Semptify Legal Document Intelligence Platform*
