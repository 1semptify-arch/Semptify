...
class CopilotClient(BaseClient):
    ...
    def analyze_case(self, document_ids: list[str] | None = None) -> dict[str, Any]:
    ...
    def get_recommendations(self, case_context: dict | None = None) -> list[dict[str, Any]]:
...
class ComplaintClient(BaseClient):
    ...
    def list(self, status: str | None = None) -> list[Complaint]:
        """List complaints."""
        params = {}
        if status:
