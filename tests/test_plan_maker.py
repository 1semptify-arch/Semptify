...
class TestPlanMakerService:
    ...
    def test_add_entity(self):
        ...
        updated = add_entity(plan, EntityRecord(name="Example LLC", role="landlord", address="123 Main"))
        assert len(updated.entities) == 1
        assert updated.entities[0].name == "Example LLC"
...
class TestPlanMakerRouter:
    ...
    def test_create_plan(self):
        ...
        assert data["plan"]["landlord_name"] == "Example Property Management"
    ...
    def test_add_entity(self):
        ...
        assert any(e["name"] == "Example LLC" for e in updated["entities"])
