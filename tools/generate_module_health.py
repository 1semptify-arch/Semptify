...
OUT_OF_SCOPE = {
    ...
    "eviction_defense_content": "dead weight — no module code or product manifest entry; registry cleanup tracked",
    "ai_copilot": "dead weight — no module code or product manifest entry; registry cleanup tracked",
}
