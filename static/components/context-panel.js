...
(function () {
    ...
    if (!document.getElementById('ctx-panel-styles')) {
        ...
        style.textContent = [
            '[data-context-panel]{background:var(--color-gray-50);border:1px solid var(--color-gray-200);border-radius:12px;padding:1.25rem;margin:1.5rem 0}',
            '.ctx-heading{font-size:0.95rem;font-weight:700;color:var(--color-gray-800);margin-bottom:0.75rem}',
            '.ctx-section{margin-bottom:1rem}',
            '.ctx-section:last-child{margin-bottom:0}',
            '.ctx-fact{background:var(--color-white);border:1px solid var(--color-gray-200);border-radius:8px;padding:0.75rem 1rem;margin-bottom:0.5rem}',
            '.ctx-claim{font-size:0.875rem;color:var(--color-gray-800);line-height:1.5;margin-bottom:0.4rem}',
            '.ctx-meta{display:flex;align-items:center;gap:0.75rem;font-size:0.75rem;color:var(--color-gray-500)}',
            '.ctx-jurisdiction{background:var(--color-calm-100);color:var(--color-calm-dark);padding:0.1rem 0.4rem;border-radius:4px;font-weight:600}',
            '.ctx-verified{color:var(--color-success);font-weight:600}',
            '.ctx-unverified{color:var(--color-alarm)}',
            '.ctx-source{color:var(--color-info);text-decoration:none;margin-left:auto}',
            '.ctx-source:hover{text-decoration:underline}',
            '.ctx-story{background:var(--color-warning-50);border:1px solid var(--tone-400);border-radius:8px;padding:0.75rem 1rem;margin-bottom:0.5rem}',
            '.ctx-story-body{font-size:0.875rem;color:var(--color-warning-800);line-height:1.5;margin-bottom:0.4rem;font-style:italic}',
            '.ctx-story-outcome{font-size:0.8rem;color:var(--color-warning-800)}',
            '.ctx-story-tag{display:inline-block;background:var(--color-calm-100);color:var(--color-success-800);padding:0.1rem 0.5rem;border-radius:4px;font-size:0.7rem;font-weight:600;margin-top:0.3rem}',
            '.ctx-empty{color:var(--color-calm-light);font-size:0.85rem;padding:0.5rem 0}',
            '.ctx-loading{color:var(--color-calm-light);font-size:0.85rem;padding:0.5rem 0}',
        ].join('\n');
