...
STRINGS: dict[str, dict[str, str]] = {
    # Navigation
    "nav_home": {"en": "Home", "es": "Inicio", "so": "Bogga Hore", "ar": "الرئيسية"},
    "nav_answer": {"en": "File Answer", "es": "Presentar Respuesta", "so": "Xaree Jawaab", "ar": "تقديم الرد"},
    "nav_counterclaim": {"en": "Counterclaim", "es": "Contrademanda", "so": "Dacwad Lid ah", "ar": "دعوى مضادة"},
    "nav_motions": {"en": "Motions", "es": "Mociones", "so": "Codsiyada", "ar": "الطلبات"},
    "nav_hearing": {
        "en": "Hearing Prep",
    ...
    # Common Actions
    "btn_next": {"en": "Next Step", "es": "Siguiente Paso", "so": "Tallaabada Xigta", "ar": "الخطوة التالية"},
    "btn_back": {"en": "Go Back", "es": "Regresar", "so": "Dib u Noqo", "ar": "رجوع"},
    "btn_save": {"en": "Save Progress", "es": "Guardar Progreso", "so": "Kaydi Horumarka", "ar": "حفظ التقدم"},
    "btn_download": {"en": "Download PDF", "es": "Descargar PDF", "so": "Soo Deji PDF", "ar": "تحميل PDF"},
    "btn_print": {"en": "Print", "es": "Imprimir", "so": "Daabac", "ar": "طباعة"},
    "btn_submit": {"en": "Submit", "es": "Enviar", "so": "Dir", "ar": "إرسال"},
    "btn_cancel": {"en": "Cancel", "es": "Cancelar", "so": "Kansal", "ar": "إلغاء"},
    # Headings
    "title_main": {
    ...
    "title_motions": {"en": "File a Motion", "es": "Presente una Moción", "so": "Xaree Codsi", "ar": "قدم طلب"},
    "title_hearing": {
...
def get_language_names() -> dict[str, str]:
    ...
    return {"en": "English", "es": "Español", "so": "Soomaali", "ar": "العربية"}
